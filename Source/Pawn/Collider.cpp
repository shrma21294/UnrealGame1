...
void ACollider::Tick(float DeltaTime)
{
	...
	FRotator NewSprinArmRotation = SpringArm->GetComponentRotation();
	NewSprinArmRotation.Pitch = FMath::Clamp(NewSprinArmRotation.Pitch += CameraInput.Y, -80.f, -15.f);

	SpringArm->SetWorldRotation(NewSprinArmRotation);
